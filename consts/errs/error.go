...
var (
	...
	TransactionEmptyCancel  = newErr(-26, "Transaction err, empty cancel")
	TransactionEmptyConfirm = newErr(-26, "Transaction err, empty confirm")
	GiftGroupNotFound       = newErr(-27, "Gift group not found")
	UnsupportedItemType     = newErr(-28, "Unsupported item type")
)
